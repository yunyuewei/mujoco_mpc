...
#ifndef MJPC_PLANNERS_HIERARCHICAL_SAMPLING_PLANNER_H_
#define MJPC_PLANNERS_HIERARCHICAL_SAMPLING_PLANNER_H_
...
class HierarchicalSamplingPlanner : public RankedPlanner {
 public:
  // constructor
  HierarchicalSamplingPlanner() = default;

  // destructor
  ~HierarchicalSamplingPlanner() override = default;
  ...
  // policy
  HierarchicalSamplingPolicy policy;  // (Guarded by mtx_)
  HierarchicalSamplingPolicy candidate_policy[kMaxTrajectory];
  HierarchicalSamplingPolicy previous_policy;
